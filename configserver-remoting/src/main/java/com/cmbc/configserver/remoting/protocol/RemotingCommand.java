...
import com.cmbc.configserver.remoting.annotation.*;
import com.cmbc.configserver.remoting.exception.RemotingCommandException;
import com.cmbc.configserver.remoting.CommandCustomHeader;
...
public class RemotingCommand implements Serializable {
	...
	/**
	 * the header of the remote command
	 */
	private int code;
	...
	public static RemotingCommand createResponseCommand(
		...
		RemotingCommand cmd = createResponseCommand(
	...
	public static RemotingCommand createResponseCommand(int code,
			String remark, Class<? extends CommandCustomHeader> classHeader) {
		RemotingCommand cmd = new RemotingCommand();
	...
	public CommandCustomHeader decodeCommandCustomHeader(
		...
		if (this.extFields != null) {
			...
			Iterator<Entry<String, String>> it = this.extFields.entrySet()
					.iterator();
			while (it.hasNext()) {
				...
				try {
					Field field = objectHeader.getClass()
	...
	public static RemotingCommand decode(final ByteBuffer byteBuffer) {
		...
		RemotingCommand cmd = RemotingSerializable.decode(headerData,
	...
	public String toString() {
		return "RemotingCommand [code=" + code + ", language=" + language
				+ ", version=" + version + ", opaque=" + opaque + ", flag(B)="
				+ Integer.toBinaryString(flag) + ", remark=" + remark
				+ ", extFields=" + extFields + "]";
	}
}